...
class RegisterActivity : AppCompatActivity() {
    ...
    private fun sendOtpToEmail() {
        ...
        val password = "TemporaryPassword123" // Temporary password for user creation
        ...
        // Register user with email and temporary password
                    ...
                    user?.sendEmailVerification()
                        ?.addOnCompleteListener { verificationTask ->
                            if (verificationTask.isSuccessful) {
                                Toast.makeText(this, "Verification email sent to $email. Please verify your email.", Toast.LENGTH_SHORT).show()
                            } else {
    ...
    private fun updateEmailVerifiedUI() {
        ...
        btnSendOtp.setBackgroundColor(ContextCompat.getColor(this, R.color.colorVerified)) // Ensure the color is defined in your resources
