...
class insectbite : BaseActivity() {
    ...
    private val topicId = "insectbite" // Unique ID for the topic
    private val topicTitle = "Insect Bites/Sting" // Topic title for display
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        supportActionBar?.title = getString(R.string.insect_bites_t)
