...
class EmergencyFoodSafety : BaseActivity() {
    ...
    private val topicId = "emergency food safety" // Unique ID for the topic
    private val topicTitle = "Emergency Food Safety" // Topic title for display

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_emergency_food_safety)
        ...
        supportActionBar?.title = getString(R.string.emergency_food_safety_t)
