...
class TraumaInformedCare : BaseActivity() {

    private lateinit var webView1: WebView
    private lateinit var fabSave: FloatingActionButton
    private val topicId = "trauma-informed care" // Unique ID for the topic
    private val topicTitle = "Trauma-Informed Care" // Topic title for display
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        supportActionBar?.title = "TRAUMA-INFORMED CARE"
