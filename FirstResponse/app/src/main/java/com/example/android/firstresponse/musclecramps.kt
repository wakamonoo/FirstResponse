...
class musclecramps : BaseActivity() {

    private lateinit var webView1: WebView
    private lateinit var fabSave: FloatingActionButton
    private val topicId = "muscle_cramps" // Unique ID for the topic
    private val topicTitle = "Muscle Cramps" // Topic title for display

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_muscle_cramps)
        ...
        supportActionBar?.title = getString(R.string.muscle_cramps_t)
