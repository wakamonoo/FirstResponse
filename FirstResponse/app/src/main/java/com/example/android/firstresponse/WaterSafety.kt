...
class WaterSafety : BaseActivity() {

    private lateinit var webView1: WebView
    private lateinit var fabSave: FloatingActionButton
    private val topicId = "water safety" // Unique ID for the topic
    private val topicTitle = "Water Safety" // Topic title for display

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_water_safety)
        ...
        supportActionBar?.title = getString(R.string.water_safety_t)
