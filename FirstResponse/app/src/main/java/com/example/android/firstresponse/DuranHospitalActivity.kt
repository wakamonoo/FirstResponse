...
class DuranHospitalActivity : AppCompatActivity() {
    ...
    companion object {
        ...
        private const val TAG = "DuranHospitalActivity"
        private const val DURAN_HOSPITAL_LAT = 13.23949964230311
        private const val DURAN_HOSPITAL_LNG = 123.55779582828634
    }
    ...
    val content: TextView = findViewById(R.id.content_duran_hospital)
        ...
        locationCallback = object : LocationCallback() {
            override fun onLocationResult(locationResult: LocationResult) {
                ...
                if (location != null) {
                    val distance = calculateDistance(location.latitude, location.longitude, DURAN_HOSPITAL_LAT, DURAN_HOSPITAL_LNG)
    ...
    private fun openMapsWithDirections(currentLocation: Location) {
        ...
        val destination = "$DURAN_HOSPITAL_LAT,$DURAN_HOSPITAL_LNG"
