...
class OasRhuActivity : AppCompatActivity() {
    ...
    companion object {
        ...
        private const val TAG = "OasRhuActivity"
        private const val OAS_RHU_LAT = 13.257664988025333
        private const val OAS_RHU_LNG = 123.49984544660057
    }

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_oas_rhu)
        ...
        supportActionBar?.title = "OAS RURAL HEALTH UNIT"  // Replace with your desired title
        ...
        val content: TextView = findViewById(R.id.content_oas_rhu)
        val buttonGetDirections: Button = findViewById(R.id.button_get_directions_oas_rhu)
        val distanceTextView: TextView = findViewById(R.id.distance_text_view_oas_rhu)
        val buttonContact: Button = findViewById(R.id.button_contact_oas_rhu)
        ...
        locationCallback = object : LocationCallback() {
            override fun onLocationResult(locationResult: LocationResult) {
                ...
                if (location != null) {
                    val distance = calculateDistance(location.latitude, location.longitude, OAS_RHU_LAT, OAS_RHU_LNG)
    ...
    private fun openMapsWithDirections(currentLocation: Location) {
        ...
        val destination = "$OAS_RHU_LAT,$OAS_RHU_LNG"
