...
class headache : BaseActivity() {
    ...
    private val topicId = "headache" // Unique ID for the topic
    private val topicTitle = "Headaches" // Topic title for display purposes
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        supportActionBar?.title = getString(R.string.headaches_t)
