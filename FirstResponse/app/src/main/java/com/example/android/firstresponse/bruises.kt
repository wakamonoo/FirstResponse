...
class bruises : BaseActivity() {

    private lateinit var webView1: WebView
    private lateinit var fabSave: FloatingActionButton
    private val topicId = "bruises" // Unique ID for the topic
    private val topicTitle = "Bruises" // Topic title for display
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        supportActionBar?.title = getString(R.string.bruises_t)
