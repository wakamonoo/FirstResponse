...
class snakebite : BaseActivity() {

    private lateinit var webView1: WebView
    private lateinit var fabSave: FloatingActionButton
    private val topicId = "snakebite" // Unique ID for the topic
    private val topicTitle = "SnakeBite" // Topic title for display
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        supportActionBar?.title = getString(R.string.snake_bite_t)
