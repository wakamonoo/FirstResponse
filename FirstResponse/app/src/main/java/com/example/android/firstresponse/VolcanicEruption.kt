...
class VolcanicEruption : BaseActivity() {

    private lateinit var webView1: WebView
    private lateinit var fabSave: FloatingActionButton
    private val topicId = "volcanic eruption" // Unique ID for the topic
    private val topicTitle = "Volcanic Eruption Safety Tips" // Topic title for display
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        supportActionBar?.title = getString(R.string.volcanic_eruption_t)
