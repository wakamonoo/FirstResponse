...
class DailyFoodSafety : BaseActivity() {

    private lateinit var webView1: WebView
    private lateinit var fabSave: FloatingActionButton
    private val topicId = "daily food safety" // Unique ID for the topic
    private val topicTitle = "Daily Food Safety" // Topic title for display
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        supportActionBar?.title = getString(R.string.daily_food_safety_t)
