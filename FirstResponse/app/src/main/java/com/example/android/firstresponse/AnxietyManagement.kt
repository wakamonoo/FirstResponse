...
class AnxietyManagement : BaseActivity() {

    private lateinit var webView1: WebView
    private lateinit var fabSave: FloatingActionButton
    private val topicId = "anxiety management" // Unique ID for the topic
    private val topicTitle = "Anxiety Management" // Topic title for display
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        supportActionBar?.title = getString(R.string.anxiety_management_t)
