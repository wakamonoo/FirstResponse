...
class StressReduction : BaseActivity() {

    private lateinit var webView1: WebView
    private lateinit var fabSave: FloatingActionButton
    private val topicId = "stress_reduction" // Unique ID for the topic
    private val topicTitle = "Stress Reduction" // Topic title for display
    ...
    // Setup WebView
        ...
        val videoId = "Wh5HyJ1rxzk" // Video ID for stress reduction
