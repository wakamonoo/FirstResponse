...
class blister : BaseActivity() {

    private lateinit var webView1: WebView
    private lateinit var fabSave: FloatingActionButton
    private val topicId = "blister" // Unique ID for the topic
    private val topicTitle = "Blisters" // Topic title for display
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        supportActionBar?.title = getString(R.string.blisters_t)
